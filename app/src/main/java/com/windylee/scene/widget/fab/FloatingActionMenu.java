package com.windylee.scene.widget.fab;
...
import com.windylee.scene.utils.VersionUtil;
...
public class FloatingActionMenu extends ViewGroup {
    ...
    private int mButtonSpacing = VersionUtil.dpToPx(getContext(), 0f);
    private FloatingActionButton mMenuButton;
    private int mMaxButtonWidth;
    private int mLabelsMargin = VersionUtil.dpToPx(getContext(), 0f);
    private int mLabelsVerticalOffset = VersionUtil.dpToPx(getContext(), 0f);
    ...
    private int mLabelsPaddingTop = VersionUtil.dpToPx(getContext(), 4f);
    private int mLabelsPaddingRight = VersionUtil.dpToPx(getContext(), 8f);
    private int mLabelsPaddingBottom = VersionUtil.dpToPx(getContext(), 4f);
    private int mLabelsPaddingLeft = VersionUtil.dpToPx(getContext(), 8f);
    private ColorStateList mLabelsTextColor;
    private float mLabelsTextSize;
    private int mLabelsCornerRadius = VersionUtil.dpToPx(getContext(), 3f);
    ...
    private void createMenuButton() {
        ...
        if (mMenuShowShadow) {
            mMenuButton.mShadowRadius = VersionUtil.dpToPx(getContext(), mMenuShadowRadius);
            mMenuButton.mShadowXOffset = VersionUtil.dpToPx(getContext(), mMenuShadowXOffset);
            mMenuButton.mShadowYOffset = VersionUtil.dpToPx(getContext(), mMenuShadowYOffset);
        }
